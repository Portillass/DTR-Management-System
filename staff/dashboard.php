...
mysqli_stmt_execute($stmt);
$weeklyData = mysqli_stmt_get_result($stmt);

// Get monthly hours data for graph
$sql = "SELECT 
            DATE(date) as date,
...
mysqli_stmt_bind_param($stmt, "i", $user_id);
mysqli_stmt_execute($stmt);
$monthlyHours = mysqli_stmt_get_result($stmt);
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="card stat-card bg-primary text-white">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <i class="fas fa-calendar-check stat-icon"></i> Today's Status
                                </h5>
                                <?php if ($todayAttendance): ?>
                                    <div class="mt-3">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <button class="btn btn-light" onclick="checkOut()">Check Out</button>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
                                    <div class="mt-3">
                                        <p>You haven't checked in today.</p>
                                        <button class="btn btn-light" onclick="checkIn()">Check In</button>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="card stat-card bg-success text-white">
                            <div class="card-body">
                                <h5 class="card-title">
                                    <i class="fas fa-chart-pie stat-icon"></i> Monthly Summary
                                </h5>
                                <div class="mt-3">
